...
void buf_afficher_page()
{
    ...
    rectfill(page,15,15,100,100,makecol(150,150,150));
        rectfill(page,915,15,1000,100,makecol(150,150,150));
        rectfill(page,550,650,650,700,makecol(0,0,0));
        rectfill(page,400,650,500,700,makecol(15,15,15));
    blit(page, screen, 0,0,0,0,1024,778);
    release_screen();
}
